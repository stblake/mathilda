...
MobiusInvolution[{a_, b_}, {c_, d_}, t_] :=
  Which[
    ...
    d === Infinity,
      Cancel[Together[(c t + a b - c (a + b))/(t - c),
                      Extension -> Automatic], Extension -> Automatic],
    True,
      Cancel[Together[((a b - c d) t + (a + b) c d - (c + d) a b)/
                      (((a + b) - (c + d)) t - (a b - c d)),
                      Extension -> Automatic], Extension -> Automatic]
  ];
