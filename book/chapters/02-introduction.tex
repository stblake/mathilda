...
Near a point a function is captured by its power series, and \B{Series} computes it to any
...
\pair{02-introduction/calculus-series/3}{At a pole the expansion is a \emph{Laurent}
...
\texttt{SeriesData} object a series is into an ordinary polynomial.}
\end{codepairs}
