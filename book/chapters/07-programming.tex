...
table (\texttt{src/symtab.c}) as a linked list. New DownValues go to the front,
but Mathilda keeps genuinely more-specific patterns ahead of more-general ones so
that \texttt{fib[0]} is tried before \texttt{fib[n\_]}. Evaluating
