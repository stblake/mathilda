...
on the core architecture and evaluation semantics of the Wolfram Language\index{Wolfram Language}, and it
...
\begin{itemize}
  ...
  \item \textbf{LAPACK}\index{LAPACK} and \textbf{BLAS}\index{BLAS} (here, Apple's Accelerate framework)
