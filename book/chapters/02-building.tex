...
For an expression too long or too structured to sit comfortably on one line, end a
line with a backslash (\texttt{\textbackslash}) and Mathilda waits for more before
evaluating, letting you spread a definition across several lines and press Return on
the last to run the whole thing.
