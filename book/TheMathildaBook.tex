...
\tableofcontents*
% \input{frontmatter/preface}   % preface deferred until the book is further along

\mainmatter

\include{chapters/01-about}
\include{chapters/02-introduction}
\include{chapters/03-mathematics}
\include{chapters/04-graphics}
\include{chapters/05-data-structures}
\include{chapters/06-programming}
\include{chapters/07-compilation}
\include{chapters/08-data-io}
\include{chapters/09-internals}
\include{chapters/10-development}
\include{chapters/11-contributing}
\include{chapters/12-about-the-author}
