...
GeneratedParameters is an option for Solve specifying the head used for fresh integer-parameter symbols introduced by the inverse-function specialist.  Default: C, giving C\[1\], C\[2\], ...  Only the bare-symbol form is honoured; the Function form is reserved.
