...
Quartics is an option for Solve that controls whether quartic equations are solved via explicit radical formulas (Quartics -\> True) or returned as held Root\[\] objects (default Quartics -\> False).
