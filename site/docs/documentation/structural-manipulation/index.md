...
- [`FactorSquareFreeList`](FactorSquareFreeList.md) — FactorSquareFreeList[poly] gives a list of the square-free factors of poly  _(Stable)_
...
- [`MonomialList`](MonomialList.md) — MonomialList[poly] gives the list of monomials of poly, using Variables[poly].  _(Stable)_
- [`Order`](Order.md) — Order[e1, e2] gives 1 if e1 is before e2 in canonical order, -1 if e1 is after e2, and 0 if e1 is identical to e2.  _(Stable)_
