...
In[6]:= Total[{{1, 2}, {3, 4}, {5, 6}}]
Out[6]= {9, 12}

In[7]:= Total[{{1, 2}, {3, 4}, {5, 6}}, {2}]
Out[7]= {3, 7}

In[8]:= Total[Table[Binomial[10, k], {k, 0, 10}]]
Out[8]= 1024

In[9]:= Total[Table[1/k^2, {k, 1, 100}]]
Out[9]= 1589508694133037873112297928517553859702383498543709859889432834803818131090369901/972186144434381030589657976672623144161975583995746241782720354705517986165248000
```
