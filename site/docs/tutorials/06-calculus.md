...
expression-rewriting engine you met in the [algebra tutorial](05-algebra.md) —
...
[precision tutorial](04-machine-and-arbitrary-precision-arithmetic.md) for what
those decimals mean).
...
optimisation. Together with the [algebra tutorial](05-algebra.md) this covers the
