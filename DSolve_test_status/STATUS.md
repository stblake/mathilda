...
`ctest -R dsolve_corpus_2_1_2_tests` · gate baseline **628** (M58 higher-order autonomous reduction).
...
| 3rd_high_reducible    |  34 |   8 |  26 | 23.5 | **M58 higher-order autonomous reduction +1** (1143 `y y'''==y'y''`, missing-x, elementary quadrature); residue = non-elementary stage-2 quadratures (need implicit first integral) + `_mu_y2`/exact-ODE families |
