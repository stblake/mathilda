...
static bool si_solve_box_modsieve(SICtx* c, SearchState* st) {
...
static bool si_solve_biquadrate_frye(SICtx* c, SearchState* st) {
...
static bool si_solve_separable_mitm(SICtx* c, SearchState* st) {
    if (c->neq != 1) return false;
    int n = c->n;
