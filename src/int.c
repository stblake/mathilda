 ...
 * int.c
 *
 * IntegerDigits — decompose an integer into a list of base-b digits.
 *
 ...
 *
 * Sign of n is discarded.  IntegerDigits[0] -> {0}.  Threading over list
 * arguments is handled automatically by the evaluator (Listable).
 *
