...
void info_init(void) {
    ...
    symtab_set_docstring("NLimit",
        ...
        "resolved accurately. Method -> EulerSum forces Richardson/Romberg; "
        "Method -> SequenceLimit forces Wynn's epsilon. expr must be numerical "
        "when z is numerical. Small spurious residuals are not recognised as "
        "zero -- Chop if needed.\n\n"
        "Options: Method (Automatic | EulerSum | SequenceLimit), WorkingPrecision (default "
