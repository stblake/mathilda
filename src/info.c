...
void info_init(void) {
    ...
    symtab_set_docstring("NMinimize",
        ...
        "-> s}.  \"NelderMead\" also takes \"ExpandRatio\" (simplex expansion "
        "coefficient, default 2) and \"ContractRatio\" (contraction, default "
        "0.5).  \"PostProcess\" -> False (any method) skips the final local "
        "polish and returns the raw global-search point.\n\n"
        "Options:\n"
        ...
        "variables.  The search is deterministic for a fixed RandomSeed.  "
        "Returns {fmin, {x -> xmin, ...}}.");
