...
void info_init(void) {
    ...
    symtab_set_docstring("NMinimize",
        ...
        "NMinimize has HoldAll and effectively uses Block to localize the "
        "variables.  The search is deterministic for a fixed RandomSeed.  At "
    ...
    symtab_set_docstring("NMaximize",
        ...
        "NMaximize has HoldAll and shares NMinimize's methods, options, and "
