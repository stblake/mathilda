...
void info_init(void) {
    ...
    symtab_set_docstring("NSum",
        ...
        "Wynn's epsilon (partial-sum acceleration) otherwise, with Levin's "
        "u-transform as a last resort; large finite sums use the difference of "
        "two infinite tails. Method -> \"Levin\" forces Levin's transformation "
